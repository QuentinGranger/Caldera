  ...
  return (
    <section className={styles.summary} aria-label="Récapitulatif du panier">
      ...
      <p className={styles.note}>
        Les articles du panier ne sont pas réservés à ce stade. Les prix et
        disponibilités seront vérifiés avant la commande, puis la sélection sera
        réservée pendant la tentative de paiement.
      </p>
    </section>
  );
}
